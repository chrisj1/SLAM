#include "Roomba.h"
    ...
    void Roomba::sendSensorStream() {
        ...
        commandSequence[1] = sensors.size();
...
void Roomba::parseBytes(const unsigned char *headerByte, unsigned char size) const {
